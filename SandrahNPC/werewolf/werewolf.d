...
CreateCreature("durlyl2",[3541.2782],0)
StartCutSceneMode()
StartCutScene("dw#kcut1")~ EXIT
IF ~Gender(Player1,Male)~ THEN DO
~ClearAllActions()
SetGlobal("DMWWKaishasChat","GLOBAL",1)
CreateCreature("delain2",[3541.2782],0)
StartCutSceneMode()
...
CHAIN
IF WEIGHT #-999 ~Global("DMWWKaishasChat","GLOBAL",1) ~ THEN ~delainy2~ plea1
@21630 
==kaish2 @21631
DO
~ClearAllActions()
CreateCreature("marale2",[3540.2780],0)
StartCutSceneMode()
StartCutScene("dw#kcut3")~
EXIT

CHAIN
IF WEIGHT #-999 ~Global("DMWWKaishasChat","GLOBAL",1) ~ THEN ~durlyle2~ plea2
@21630
==kaish2 @21631
DO
~ClearAllActions()
...
CHAIN
IF WEIGHT #-999 ~Global("DMWWKaishasChat","GLOBAL",1)Gender(Player1,Male)~ THEN ~marale2~ okaythen1
@21632 
==kaish2 @21633 
= @21634 
==marale2 @21635
==delainy2 @21636
DO ~SetGlobal("DMWWNoKillKaishas","GLOBAL",1) GiveItemCreate("misc1c",Player1,0,0,0) 
ActionOverride("maralee",EscapeArea())
 ActionOverride("durlyle",EscapeArea())
	ActionOverride("kaish2",EscapeArea())
 EscapeArea()	~
EXIT

CHAIN
IF WEIGHT #-999 ~Global("DMWWKaishasChat","GLOBAL",1)Gender(Player1,Female)~ THEN ~marale2~ okaythen2
@21632 
==kaish2 @21633
= @21634 
==marale2 @21635 
...
DO ~SetGlobal("DMWWNoKillKaishas","GLOBAL",1) GiveItemCreate("misc1c",Player1,0,0,0) 
ActionOverride("maralee",EscapeArea())
 ActionOverride("delainy",EscapeArea())
	ActionOverride("kaish2",EscapeArea())
 EscapeArea()
~
EXIT
...
IF ~PartyHasItem("BOOK87")~ THEN REPLY @21655 GOTO 6
