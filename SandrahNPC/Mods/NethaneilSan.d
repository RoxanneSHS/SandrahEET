...
== SK#Neht IF ~InParty("CVSandr")~ THEN~ (Looks at Sandrah fully astonished.) Your lore is exceptional for one so young. Indeed Amaunator is the only god of the sun I know of, but where you come from he may be forgotten by most. (Sighs) Like by those cursed worshippers down here.~
...
==BSandr~So it was not at the Times of Trouble when Midnight took Mystra's coat and name that the first human was granted such an ascension by AO!~
...
==BSK#NEHT~But? You cannot hide the small sadness I hear in your voice - I have not learned to know you as being pessimistic, My lady Sandrah.~
...
==BSK#NEHT~More work for your hammer then, my lady.~
...
==BSK#NEHT~One would not exclude the other, young one. I see you as one who is without a prejudice towards others. You took me from the beginning for the person I am and I was rather than for the strange abnormality my current state implies.~
