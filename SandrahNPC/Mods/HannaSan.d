CHAIN
IF~Global("HannaSan","LOCALS",1)~THEN BHanna SanPellig1
~*Hanna slowly and cautiously approaches Sandrah's large companion Pelligram.*~
DO~SetGlobal("HannaSan","LOCALS",2) ~
==PELLIG~Purr!!~
==BHanna~You are beautiful and very strong. I hope your mistress treats you well.~
==PELLIG~Purr!!~
==BSandr~I hope she will confirm my good treatment, even if I am not her *mistress*. ~
==BHanna~Have you not tamed her and made her follow you, Sandrah?~
==BSandr~I have saved her long time ago from slavers and we are together since then, she is my friend and my companion, not my pet or my thrall.~
==BHanna~You do not look like one who cares or even loves animals.~
==BSandr~You mean I do not look like I sleep on a pile of leaves and bath in a clear mountain spring?~
==BHanna~Hi hi, but I saw you do that this very morning - you're right, your big city aura and ladylike behaviour misled me, I guess.~
...
==BHanna~The same, basically, a father who taught me my skills to fight for peace and justice - only that the laws of my community and the fact that I had brothers restrict a female to fully develop like I thought I should.~
=~Oh, my, we need to join the others now. I have rarely spoken so many words with a kind person for a long time...~EXIT