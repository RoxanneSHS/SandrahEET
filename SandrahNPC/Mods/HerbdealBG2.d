...
== ~B!HERB06~IF~InParty("CVSandr") Global("SanRomPath","GLOBAL",1)~THEN ~My lady, sometimes their effect on a male is much wanted in a given situation.~
...
== CVSANDRJ IF~InParty("CVSandr") Global("SanRomPath","GLOBAL",2) OR(2) InParty("Driz2") InParty("P#Kivan")~THEN ~Be careful, my love thirsty leader, you do not want to buy those Cassil herbs.~
