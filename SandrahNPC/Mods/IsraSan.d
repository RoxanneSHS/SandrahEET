...
~Seeing thee interact so easily and still passionately with the other gender makes me consider thou wouldst make a valid disciple of Sune yourself.~
...
==BRH#ISRA~And whatst about thine own service of Mystra?~
...
==BRH#ISRA~Many are healers but few have your dedication - many interact between the sheets but few make it an art like thou dost and I do. ~
...
==BRH#ISRA~See - calling Sune by that name shows thou canst relate to her attitude after all.~
...
==BRH#ISRA~*Isra expertly fastens a stray lock of Sandrah's hair to a circlet the priestess has chosen to wear this day.*~
==BSandr~Thanks...there is nothing I can do in return for you. You are just perfect in your style as always.~
==BRH#ISRA~This is a most welcome compliment as I admit thou are among the few I wouldst accept as judge on such issues as hairstyle and clothing.~
==BSandr~A paladin and utterly seductive, you manage to keep your high standard daily.~
==BRH#ISRA~It is part of my service to my goddess, Sandrah. But thou dost the same - for Mystra?~
...
==BRH#ISRA~(Laughs out loud) Oh, yes, Midnight is told to have broken some men's hearts in her time - just as her priestess seems to do these days.~
