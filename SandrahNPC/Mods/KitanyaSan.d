...
==BSandr~ I doubt that you can really make your threat become reality. But I do not seek quarrelling with you for the same reason you have stated already - we both serve the tasks of <CHARNAME>'s group.~
...
==R#Kityb~You are not a coward and well educated and knowledgeable, Sandrah. Maybe your view of magic and your use of it differs from the kind I have set out to destroy. Our time together in this group may become interesting.~EXIT
...
==BSandr~In our pursuit of <CHARNAME>'s foe, the mage we try to find, I have come to the conclusion that he might be of your kin, at least from his origin.~
==R#Kityb~His origin? (Kitanya is obviously struggling to maintain her composure.)~
==BSandr~He and his sister must have committed some crime that has forever made them outcasts if not foes of the elven society. However, we have no way to get further insight as such affairs are not shared by the elves with any N'Tel'Quessir.~
...
==BSandr~It is me who has to apologize. I acted despite my knowledge of elven custom and I overstepped the line between comrades in arms.~
