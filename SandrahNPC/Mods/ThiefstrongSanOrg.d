...
IF~ GlobalGT("aranjob","GLOBAL",1)~ THEN REPLY~ I do not owe anything to Renal any more, *Jester*. You seem to be unaware that things have changed a bit around here. ~GOTO 300
...
~ THEN REPLY~ I do not owe anything to Renal any more, *Jester*. You seem to be unaware that things have changed a bit around here. ~GOTO 300
END
...
IF~~THEN REPLY~ Renal has no means any more to make demands here, just in case you haven't heard yet. This guild is under my control and mine alone. You better leave immediately before things get painful for you.~ GOTO 301
END
