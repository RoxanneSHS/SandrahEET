...
== CVGonast~This will be no problem, my lady. Your document will be delivered by one of our trusted men personally. A ship is due to leave for Waterdeep the day after tomorrow and you have my word that your message will be on its way with it.~
...
== CVGonast~Oh, this is not necessary after all you did...well, yes, on second thought it's welcome, my lady, we need a lot of resources for those who suffered from the hateful snakes. Thank you again, you all, and good journey.~DO~AddexperienceParty(5650) TakePartyGold(1500) EscapeArea()~EXIT
...
SAY~We should follow Rynn's advice to check out the lower levels, <CHARNAME>. Before we do, we should however fill up our ranks again. My parcel can take us to any of our comrades and back to Hlondeth again, just to remind you.~
...
IF~~THEN REPLY~No, those are rebels and troublemakers, I will not interfere with the order in some remote and foreign town of which we know not enough.~DO~IncrementGlobal("Sanpoints","GLOBAL",-10) SetGlobal("SanMystrev","ar3610",2) ~EXIT
...
++~I trust you more than ever, counsellor, you know your fellow priests better than any.~EXTERN CVSandrJ SanSmellTrap2
