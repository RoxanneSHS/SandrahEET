...
IF~~THEN REPLY ~You are his friend as well, it is good that somebody takes care of his business in the meantime. ~GOTO KarMovedInFr
END
...
IF~GlobalLT("OrcPrison","GLOBAL",12)~THEN REPLY ~It is good to see that care is been taken here. We will tell him about your help as soon as we find him. Hopefully that will be soon already.~DO ~SetGlobal("KarMovedIn","LOCALS",1)~GOTO KarShop
IF~GlobalGT("OrcPrison","GLOBAL",11)~THEN REPLY ~It is good to see that care is been taken here. We will tell him about your help when we see him again. He is safe at Waterdeep for now.~DO ~SetGlobal("KarMovedIn","LOCALS",1)~GOTO KarShop
END
