...
==  SDNPC IF ~InParty("CVSandr") Global("SanSacroll","GLOBAL",8)~ THEN~ As much as I am grateful for your kind words, mylady priestess, I am utterly sad to disappoint you. I was just following the trail of the thief to this installation. I could not get inside all by myself. I have seen guarded groups come in and out, the traffic of large cargo boxes as well but I have been warded off by the guards everytime before I could get close enough to find out what is really going on. Now that you mention slave trade, my observations begin to make sense, but I know no more.~
...
IF ~~ THEN REPLY ~Mabye... Who are you?~ GOTO 7
END  
END