...
==BSOLA25~ Both are not easily understood by the broad masses as their portefolio and heritage is tainted for many.~
...
==BSandr25~ Waterdeep, my hometown, is one of them. Even if I cannot say that I actually *worship* my goddess - I would rather claim I work for her goals and follow her example.~
...
==BSOLA25~ A question I often ponder myself - is it all preset like some prophesies let us think or do we have the freedom of our own decisions? With your background, Sandrah, you must have given this question quite some thought, haven't you?~
...
=~Your sister is really Eilistrae's High Priestess in that legendary foundation in Undermountain. The tales are rich among us believers regarding this shelter and place of hope.~
...
APPEND SOLA
IF~~THEN BEGIN Qidr1
SAY~As you wish, <CHARNAME>. I have seen the place where I can go in Eilistrae's name. You will find me in Qilandrha's enclave in Undermountain if you desire to meet me again.~
