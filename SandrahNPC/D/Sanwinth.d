...
~Tututu, sleep, my little girl, sleep, tututu.~
DO~SetGlobal("Formedcloth","GLOBAL",8)~
== GORION ~She is in good hands with you, old friend, she will not learn what evil is, at least not from her new foster father.~
== SANWINTH IF ~Global("SanRomPath","GLOBAL",2)~THEN~Such a sweet one, my little Immi, tututu. And how about your little girl, Gorion?~
== SANWINTH IF ~Global("SanRomPath","GLOBAL",1)~THEN~Such a sweet one, my little Immi, tututu. And how about your little boy, Gorion?~
== GORION ~Friend, <PRO_HESHE> knows nothing of the evil that may be lurking within <PRO_HIMHER>. And I will make sure it will stay this way.~
== ELMINSDR~Friends, I see the Harpers have done well to trust thee both with the care of these innocent little ones. But news is bad that hath reached mine ears today. The hunters have found their scent.~
...
== GORION ~Of course the fanatics who want to destroy any trace of the fallen god in fear of his prophesied return. ~
== SANWINTH ~And his followers, as they have not seized to exist. They want to preserve his spawns, but we all do not want to imagine the terrible aim they have. To resurrect the god of murder.~
...
== GORION ~Should we split our two to increase chances that the foe will not get both, just in case?~
== SANWINTH ~Splitting will also split our defensive forces. And Elminster will not be able to trace both our ways and possible dangers. Admitted, there is a risk in staying together but also more strength.~
== ELMINSDR~So it is agreed then. Thou shouldst be together and try to get beyond the Firewine first. The halflings on the other side are a good folk that cannot be tricked into treachery by any evil intent. From there plan thine next step carefully. Mystra's blessing is with you.~
==GORION~We only talked about our wards so far , good friends, you carry a burden as well, Elminster.~
== ELMINSDR~Do not worry about the little one, the Realm of Undermountain is not accessible to our foe.~DO ~EscapeArea()~
== GORION ~Sleep, innocent child, may you never know these dark days we now face.~DO ~EscapeArea()~
== SANWINTH ~Travelling, will be fun, my girl, we see the world. All will be good, tututu.~DO ~EscapeArea()~EXIT
