...
==BSANDR~ It is not often that I meet people with that insight, Valgyar. More often my goddess is blamed for all the misuse that is done with her gift.~
==BVALYGA~Maybe, mylady, the reason for that is the misconception of the roles of the gods for the mortals that most people inherit.~
...
==BVALYGA~I will gladly come back to that invitation of a longer talk with you, mylady. I hope you will share some hours with me on one of those evenings.~
==BSANDR~ I look forward to it - but, please, do not call me *mylady* all the time. We are comrads following <CHARNAME> and I am simply Sandrah for you.~
==BVALYGA~Agreed, Sandrah.~EXIT

CHAIN
IF~Global("SanValgyR","GLOBAL",2)~ THEN BSANDR SanValgy1
~(Sandrah has sat down in the shade of a tree and Pelligram cuddles at her side resting her enourmous head in Sandrah's lap.)~
...
==BVALYGA~(He sits down on Pelligrams other side and slowly strokes the large cat's fur at her neck.)~
...
==BVALYGA~ But you yourself have ressurected our fallen comrades many time from the dead, Sandrah.~ 
...
==BVALYGA~ (Valygar nods thoughfully and even manages to get his face to display an expression never shown before - a smile.)~ EXIT
...
==BVALYGA~ You hit the mark, Sandrah. Anyone would guess such. Then add to it your profession as a priestess of Mystra and my distrust of magic - call it even hate if you like - and you have all the ingrediences of the dilemma I find myself in.~
==BSANDR~ You are not trying to tell be that I am the personification of everything you dislike, Valygar?~
==BVALYGA~ That is the point, Sandrah. Given all the circumstances you should be exactly that for me...a fashionable beauty from the city of splendor casting her spells in Mystra's name - it should be enough to keep us apart forever.~
...
==BSANDR~ I would only critisize him for knowing what to do but not even trying it out of the fear to maybe fail. The intention is the first step, right?~
...
==BVALYGA~I was afraid you would just say that, Sandrah, inviting me instead of helping me prevent what cannot be. The Corthala line must end with me - I cannot allow myself to pleasure a woman in the way she truely deserves it. ~
==BSANDR~ (Sandrah stops and turns towords the ranger laying her arms around his neck.)~
...
==BVALYGA~You are determined, arent't you? You are not just a light flirt unconcious of the consequences.~
