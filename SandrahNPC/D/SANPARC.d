...
IF ~Global("RZAR0803","GLOBAL",1)GlobalLT("Chapter","GLOBAL",20)~ THEN REPLY ~Bodhi´s lair~ DO ~SetGlobal("SanTravel","GLOBAL",22)~ EXIT
IF ~Global("RZAR0803","GLOBAL",1)GlobalGT("Chapter","GLOBAL",19)~ THEN REPLY ~Bodhi´s lair~ DO ~SetGlobal("SanTravel","GLOBAL",121)~ EXIT
IF ~~ THEN REPLY ~Previous Choices.~ GOTO Choice1
IF ~~ THEN REPLY ~Nowhere~ EXIT
END
