...
CHAIN
IF ~~THEN CVTRAVI sd2
~You are an intelligent <PRO_MANWOMAN>. You have been underestimated by all. You and your friend Imoen's persistence.~
== Bimoen ~Imoen the Magnificent gotcha in the end. We always do, <CHARNAME> and I.~
==CVTRAVI ~Nobody wanted to hurt Henning. All I wanted was to have him out of the way until the end of the operation. He would have put you on our trail too early. In some ten-days it will not matter any more, but now-~
...
==CVTRAVI ~That was the initial idea, my lady, absolutely. A mercenary intrigue. Yes, sure I admit, we were scrupulous in that we accepted a few casualties, maybe a farmer hurt by a breaking plough or a soldier hurting himself with a corrupted weapon. Such is the price for the enormous gain we anticipated. But not these killings, these streams of blood caused by more and more bandits. And then those terrible orcs. None of this was on the original agenda.~
== BSANDR~And that is Sarevok's doing. Or that of his Othlor advisor.~
==CVTRAVI ~WHAT? You know about that dark mageling as well. But you are mistaken, my lady. He was fooled just like us. He thought he would control his disciple, the poor fool...~
END
++ ~(Whisper to Sandrah) Clever, my counsellor, you get it out of him bit by bit. Keep on, I will let you run this inquisition.~+sd4
...
== Bimoen ~I am in a merciful mood today, Traviman, you have this last wish free from me. Choose which way I shall kill you.~
...
== Bimoen ~Hmmm - that is true. That was the last words from that Knowlod orc, hmm.~
