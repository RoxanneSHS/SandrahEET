...
== IF_FILE_EXISTS BSUFINCH IF~ InParty("Sufinch") ~ THEN ~ Rare the writings are, but I have never heard him be named *the Great*. Not to insult a devoted follower, if one you may be, but he is normally adressed rather as *the mad*, *the weird* or *the absurd*. ~
...
++ ~ I guess you are adressing the wrong people. I am no adept of any Monty, be he mad, great or whatever. I propose to let us continue our way in peace.~ + SuBH13
...
~ Peace, my friends, booklovers like us should deal with each other in a civilized way. All we are interested in is a small booklet that you may carry with you.~
...
== BSANDR IF~ !InParty("Sufinch") ~ THEN ~ (Bluffs) Rare tooms like that are not subjects to be carried across the country in a backpack. However we can offer you this transcription I have made before we left the original at the library in Nashkel.~
END
