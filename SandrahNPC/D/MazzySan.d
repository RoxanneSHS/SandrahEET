CHAIN
IF WEIGHT #-12~Global("SanPalad1","LOCALS",3)~THEN BMAZZY SanPalad1
~You must be really close to your goddess to be blessed with such healing skills, Sandrah.~
DO~SetGlobal("SanPalad1","LOCALS",4)~
==BSandr~This gift is given to many on Faerun, Mazzy. I am not that special in this aspect.~
==BMAZZY~You are special in your determination with what you do.~
==BSandr~I am following my own way to perform Mystra's duties. Just like you rather feel what needs to be done to be a valuable paladin of Arvoreen than to require a priest's advice to guide you.~EXIT

CHAIN
IF WEIGHT #-11~Global("SanPalad1","LOCALS",5)~THEN BMAZZY SanPalad1
~You are constantly fighting for the good, Sandrah, beating not only slavers and such but also mages that do not use their skills in the way you would do. In addition, you are one of the most powerful fighters I have ever met. Why have you not considered to become a paladin of your goddess?~
