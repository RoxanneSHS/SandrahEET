...
IF ~~THEN REPLY~ Oh, my! Only the Balor could return them to the surface, but he is dead. I 'm afraid today we have witnessed a sacrifice for science. But will anyone ever know what the gnomes find out down there?~ DO~IncrementGlobal("Sanpoints","GLOBAL",1)~GOTO SanKarlini2
...
DO~SetGlobal("CVGodag","GLOBAL",4)TakePartyItem("Godag01") SmallWait(5) ForceSpell(Myself,CLERIC_DRAW_UPON_HOLY_MIGHT) SmallWait(5) GiveItemCreate("Godag02",LastTalkedToBy(Myself),1,1,0) EscapeArea() ~EXIT
